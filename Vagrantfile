...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.box = 'vagrant-heroku-301e14c9d1ac64261eb40c526bb788e7.box'
  config.vm.box_url = 'https://s3.amazonaws.com/helpful-assets/vagrant-boxes/vagrant-heroku-301e14c9d1ac64261eb40c526bb788e7.box'
