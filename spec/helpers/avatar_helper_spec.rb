...
describe AvatarHelper do
  ...
  describe '#avatar_default' do
    it 'creates an avatar with default values' do
      expect(avatar_default(person)).to eq('<img alt="55502f40dc8b7c769880b10874abc9d0" class="avatar" src="https://secure.gravatar.com/avatar/55502f40dc8b7c769880b10874abc9d0.png?s=60&amp;d=404" />')
    end
  end
  ...
  describe '#gravatar_url' do
    it 'returns a url for the persons avatar for a given size' do
      expect(gravatar_url(person.email, 30)).to eq('https://secure.gravatar.com/avatar/55502f40dc8b7c769880b10874abc9d0.png?s=60&d=404')
    end
  end
end
