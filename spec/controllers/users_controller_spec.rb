...
describe UsersController do
  ...
  let!(:person) { create(:person, user: user, first_name: 'Patrick', last_name: 'McGrath', email: 'patrick.spec@assemblymade.com', username: 'jimmy', account_id: user.accounts.first.id) }
